...
model_path=results/f1/llama3-8b/forget100/FINETUNE/seed_1001/epoch10_1e-05_FixRef_maskTrue_1.0_1.0/1/unlearn_times_1/checkpoint-last
mask=true

use_LoRA=false
save_root=results/f1
